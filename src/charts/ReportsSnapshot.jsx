...
//   const chartBg = isDark ? "#25262B" : "linear-gradient(to top, #f1f3f5, #ffffff)";
...
//             <XAxis dataKey="month" stroke={text} axisLine={false} tick={{ fontSize: 10 }} />
//             <YAxis stroke={text} axisLine={false} tick={{ fontSize: 10 }} />
//             <Tooltip
